...
<body>
	...
	<!-- Header, Nav end -->
	<link rel="stylesheet" href="<%=contextPath%>/views/movieMain/css/mainPage2.css">
        ...
        <div class="movie-info">
          <div style="display: flex; align-items: center;">
            <table style="margin-left: 12px; margin-bottom: 7px; margin-top: 7px; width:130px; table-layout: fixed;">
              <tr>
                <td style="color: white; font-weight: 900; font-size: 13px;">
                  <%= movie.getMovieTitle() %>
                </td>
              </tr>
              <tr>
          ...
          <div style="display: flex;">
            ...
            <button type="button" class="btn btn-danger" style="height:34px; width:91px; font-size: 13px;" onclick="fnComparisonAdd('<%= movie.getMovieNo() %>', '<%= movie.getTitlePath() %>');">
