...
.btn {
    border: none;
    border-radius: 5px;
    background-color: #D0B260; /* 녹색 버튼 색상 */
    color: white; /* 텍스트 색상 */
    font-size: 16px;
    cursor: pointer; 
...
<body>
    <div class="container">
        ...
        <div class="content">영화를 감상할 때, 무엇을 주로 기대합니까?</div>
        <div class="button-group">
        	<form id="tasteForm" action="<%=tsContextPath%>/taste.t4" method="post">
			    <input type="hidden" name="taste" id="tasteInput" value="">
			    <button type="submit" class="btn" id="btn1" name="taste2" value="0" onclick="setTasteValue(0)">깊이 있는 성찰이나 새로운 시각의 제공</button>
			    <br>
			    <button type="submit" class="btn" id="btn2" value="1" onclick="setTasteValue(1)">순수한 즐거움과 오락성</button>
			</form>
        </div>
    </div>
</body>
