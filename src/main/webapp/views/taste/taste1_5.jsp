...
.btn {
    border: none;
    border-radius: 5px;
    background-color: #FFA564; /* 녹색 버튼 색상 */
    color: white; /* 텍스트 색상 */
    font-size: 16px;
    cursor: pointer; 
...
<body>
    <div class="container">
        ...
        <div class="content">영화를 평가할 때 어떤 요소가 더 중요한가요?</div>
        <div class="button-group">
        	<form id="tasteForm" action="<%=tsContextPath%>/taste.t5" method="post">
			    <input type="hidden" name="taste" id="tasteInput" value="">
			    <button type="submit" class="btn" id="btn1" name="taste2" value="0" onclick="setTasteValue(0)">영화의 서사 구조와 캐릭터의 감정 변화</button>
			    <br>
			    <button type="submit" class="btn" id="btn2" value="1" onclick="setTasteValue(1)">카메라 워크와 색감, 미술적인 연출</button>
			</form>
        </div>
    </div>
</body>
