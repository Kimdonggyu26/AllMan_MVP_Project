...
.btn {
    border: none;
    border-radius: 5px;
    background-color: #8488FF; /* 녹색 버튼 색상 */
    color: white; /* 텍스트 색상 */
    font-size: 16px;
    cursor: pointer; 
...
<body>
    <div class="container">
        ...
        <div class="content">당신이 선호하는 영화의 감정적 여정은 무엇입니까?</div>
        <div class="button-group">
        	<form id="tasteForm" action="<%=tsContextPath%>/taste.t10" method="post">
			    <input type="hidden" name="taste" id="tasteInput" value="">
			    <button type="submit" class="btn" id="btn1" name="taste2" value="0" onclick="setTasteValue(0)">복잡하고 진지한 감정 변화</button>
			    <br>
			    <button type="submit" class="btn" id="btn2" value="1" onclick="setTasteValue(1)">가벼우면서도 유쾌한 감정 변화</button>
			</form>
        </div>
    </div>
</body>
