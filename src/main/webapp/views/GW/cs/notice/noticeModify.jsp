 ...
 <div class="container">
   ...
   <input type="hidden" name="no" value="<%= n.getNoticeNo() %>">
     <table class="table">
	     <tr>
	       <th id="nt1">제목</th>
	       <td><input type="text" class="form-control" id="nt2" required name="title"  value="<%= n.getNoticeTitle() %>"></td>
	     </tr>
	     <tr>
	       <th id="nc1">내용</th>
	       <td><textarea rows="10" class="form-control" id="nc2" style="resize:none;" required name="content"><%= n.getNoticeContent() %></textarea></td>
     		</tr>
      </table>
