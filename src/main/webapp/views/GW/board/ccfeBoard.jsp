    ...
    <section>
      <div class="btn-taste">
        ...
        <div class="row justify-content-center mb-3">
          ...
          <a href="<%= contextPath %>/list.CCFE" class="mx-2 btn btn-sm" id="ccfe">CCFE 게시판</a>
   ...
   <script>
      ...
      <ul class="pagination d-flex justify-content-center text-dark" id="page">
         <li class='page-item <%= pi.getCurrentPage() == 1 ? "disabled" : "" %>'>
            <a class="page-link" href="<%= contextPath%>/list.CCFE?page=<%= pi.getCurrentPage() -1 %>">&lt;</a>
         </li>
         
         <% for(int p=pi.getStartPage(); p<=pi.getEndPage(); p++) { %>
         <li class='page-item <%= p == pi.getCurrentPage() ? "active" : "" %>'>
            <a class="page-link" style="color: #ffffff;" href="<%= contextPath%>/list.CCFE?page=<%= p %>"><%= p %></a>
         </li>
         <% } %>
