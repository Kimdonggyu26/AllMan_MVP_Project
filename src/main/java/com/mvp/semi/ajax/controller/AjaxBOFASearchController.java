...
/**
 * Servlet implementation class AjaxBOFASearchController
 */
@WebServlet("/bofa.mv")
public class AjaxBOFASearchController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxBOFASearchController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = new TBoardService().TBoarBOFAConut(searchtext, searchField);
		...
		List<Board> list = new TBoardService().TboardSaerchBOFA(searchtext, pi, searchField);
