...
/**
 * Servlet implementation class AjaxFBoardControllerSearch
 */
@WebServlet("/fboards.mv")
public class AjaxFBoardControllerSearch extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxFBoardControllerSearch() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = new FBoardService().FBoarSearchCount(searchtext, searchField);
		...
		List<Board> list = new FBoardService().FboardSaerchList(searchtext, pi, searchField);
