...
/**
 * Servlet implementation class AjaxSPTFSearchController
 */
@WebServlet("/sptf.mv")
public class AjaxSPTFSearchController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxSPTFSearchController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = new TBoardService().TBoarSPTFConut(searchtext, searchField);
		...
		List<Board> list = new TBoardService().TboardSaerchSPTF(searchtext, pi, searchField);
