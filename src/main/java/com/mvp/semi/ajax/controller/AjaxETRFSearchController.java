...
/**
 * Servlet implementation class AjaxETRFSearchController
 */
@WebServlet("/etrf.mv")
public class AjaxETRFSearchController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxETRFSearchController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = new TBoardService().TBoarETRFConut(searchtext, searchField);
		...
		List<Board> list = new TBoardService().TboardSaerchETRF(searchtext, pi, searchField);
