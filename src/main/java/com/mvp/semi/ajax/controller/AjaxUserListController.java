...
/**
 * Servlet implementation class AjaxUserListController
 */
@WebServlet("/userList.ul")
public class AjaxUserListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxUserListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int listCount = new UserService().selectAllUserList(searchData);
		...
		List<User> list = new UserService().selectPagingShowUserList(pi, searchData); // map 같이 넘기기
