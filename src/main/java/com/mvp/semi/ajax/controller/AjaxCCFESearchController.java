...
/**
 * Servlet implementation class AjaxCCFESearchController
 */
@WebServlet("/ccfe.mv")
public class AjaxCCFESearchController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxCCFESearchController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = new TBoardService().TBoarCCFEConut(searchtext, searchField);
		...
		List<Board> list = new TBoardService().TboardSaerchCCFE(searchtext, pi, searchField);
