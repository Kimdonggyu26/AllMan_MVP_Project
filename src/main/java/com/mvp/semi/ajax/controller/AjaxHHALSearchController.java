...
/**
 * Servlet implementation class AjaxHHALSearchController
 */
@WebServlet("/hhal.mv")
public class AjaxHHALSearchController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxHHALSearchController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = new TBoardService().TBoarHHALConut(searchtext, searchField);
		...
		List<Board> list = new TBoardService().TboardSaerchHHAL(searchtext, pi, searchField);
