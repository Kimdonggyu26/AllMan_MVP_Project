...
/**
 * Servlet implementation class AjaxCASESearchController
 */
@WebServlet("/case1.mv")
public class AjaxCASESearchController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxCASESearchController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = new TBoardService().TBoarCASEConut(searchtext, searchField);
		...
		List<Board> list = new TBoardService().TboardSaerchCASE(searchtext, pi, searchField);
