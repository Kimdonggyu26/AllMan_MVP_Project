...
/**
 * Servlet implementation class AjaxVDSESearchController
 */
@WebServlet("/vdse.mv")
public class AjaxVDSESearchController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AjaxVDSESearchController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = new TBoardService().TBoarVDSEConut(searchtext, searchField);
		...
		List<Board> list = new TBoardService().TboardSaerchVDSE(searchtext, pi, searchField);
