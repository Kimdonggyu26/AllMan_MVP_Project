 ...
 */
@WebServlet("/taste.t5")
public class TasteFiveController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TasteFiveController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (taste != null) {
            ...
            session.setAttribute("taste5", tasteValue);
            request.getRequestDispatcher("/views/taste/taste1_6.jsp").forward(request, response);
        }else {
