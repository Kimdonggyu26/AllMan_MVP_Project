	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (taste != null) {
    		...
    		case "1111":
    			...
    			//user-mapper.xml
//    			10으로 취향번호 저장
    			tasteResult = new UserService().updateTaste(10, u);
    		...
    		case "1110":
    			...
    			tasteResult = new UserService().updateTaste(20, u);
    		...
    		case "1101":
    			...
    			tasteResult = new UserService().updateTaste(30, u);
    		...
    		case "1100":
    			...
    			tasteResult = new UserService().updateTaste(40, u);
    		...
    		case "1011":
    			...
    			tasteResult = new UserService().updateTaste(50, u);
    		...
    		case "1010":
    			...
    			//user-mapper.xml
//    			10으로 취향번호 저장
    			tasteResult = new UserService().updateTaste(60, u);
    		...
    		case "1001":
    			...
    			tasteResult = new UserService().updateTaste(70, u);
    		...
    		case "1000":
    			...
    			tasteResult = new UserService().updateTaste(80, u);
